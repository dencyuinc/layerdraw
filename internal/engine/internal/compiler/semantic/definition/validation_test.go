...
func TestPureSemanticDecoders(t *testing.T) {
	...
	formats := []struct {
		...
		{format: "email", value: strings.Repeat("a", 65) + "@example.com", want: strings.Repeat("a", 65) + "@example.com", ok: true},
		{format: "email", value: strings.Repeat("a", 245) + "@example.com", want: strings.Repeat("a", 245) + "@example.com", ok: true},
