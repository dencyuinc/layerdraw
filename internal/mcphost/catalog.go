...
const (
	...
	ToolPermissionExport  ToolPermission = "export"
	ToolPermissionPropose ToolPermission = "propose"
	ToolPermissionApply   ToolPermission = "apply"
)
...
var toolCatalog = []toolMapping{
	...
	{name: "layerdraw.preview_operations", operation: "runtime.preview_operations", description: "Preview semantic operations with impact and Access decision.", bound: true, permission: ToolPermissionPropose},
	{name: "layerdraw.preview_fragment", operation: "engine.preview_fragment", description: "Preview a scoped LDL fragment through Workbench.", bound: true, permission: ToolPermissionPropose},
	{name: "layerdraw.preview_source_patch", operation: "engine.preview_source_patch", description: "Preview a revision-bound source patch through Workbench.", bound: true, permission: ToolPermissionPropose},
	{name: "layerdraw.apply_operations", operation: "runtime.commit_operations", previewOperation: "runtime.preview_operations", requiredOperations: []string{"runtime.preview_operations", "runtime.commit_operations"}, description: "Re-preview, revalidate, and commit an operation batch through Runtime.", bound: true, permission: ToolPermissionApply},
	{name: "layerdraw.apply_source_patch", operation: "runtime.commit_operations", previewOperation: "engine.preview_source_patch", requiredOperations: []string{"engine.preview_source_patch", "runtime.commit_operations"}, description: "Re-preview a source patch and commit its authorized operation batch through Runtime.", bound: true, permission: ToolPermissionApply},
	{name: "layerdraw.stage_asset", operation: "runtime.stage_asset", description: "Stage an asset through Runtime.", bound: true, permission: ToolPermissionApply},
	...
	{name: "layerdraw.serialize_export", description: "Serialize a bounded artifact through the configured native exporter.", bound: true, permission: ToolPermissionExport},
	{name: "layerdraw.import_document", description: "Preview a document import through the configured interchange adapter.", bound: true, permission: ToolPermissionPropose},
	{name: "layerdraw.export_document", description: "Publish a document export through the configured interchange adapter.", bound: true, permission: ToolPermissionExport},
	{name: "layerdraw.list_revisions", operation: "runtime.list_revisions", description: "List bounded committed revisions.", bound: true},
	{name: "layerdraw.restore_revision", operation: "runtime.commit_operations", previewOperation: "runtime.preview_restore", requiredOperations: []string{"runtime.preview_restore", "runtime.commit_operations"}, description: "Preview, revalidate, and commit a revision restore through Runtime.", bound: true, permission: ToolPermissionApply},
	{name: "layerdraw.registry_search", operation: "registry.search", description: "Browse the canonical Registry client.", bound: false},
	{name: "layerdraw.registry_plan_install", operation: "registry.plan_install", description: "Plan a Registry transaction.", bound: true, permission: ToolPermissionPropose},
	{name: "layerdraw.registry_apply_install", operation: "registry.commit_plan", previewOperation: "registry.plan_install", requiredOperations: []string{"registry.plan_install", "registry.commit_plan"}, description: "Re-plan, revalidate, and commit a Registry transaction.", bound: true, permission: ToolPermissionApply},
...
func ToolRoutes() []ToolRoute {
	...
	for index, mapping := range toolCatalog {
		...
		result[index] = ToolRoute{Name: mapping.name, Operation: mapping.operation, PreviewOperation: mapping.previewOperation, RequiredOperations: append([]string(nil), mapping.requiredOperations...), Permission: permission}
	}
	return result
}
