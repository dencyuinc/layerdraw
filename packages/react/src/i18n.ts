...
export const baseShellCatalogs: LocaleCatalogs = {
  en: {
    ...
    "settings.capability.graph:write": "Entities & relations",
    "settings.capability.query:write": "Queries",
    "settings.capability.view:write": "View definitions",
    "settings.capability.schema:write": "Schema (type definitions)",
    "settings.capability.asset:write": "Assets",
    "settings.capability.package:manage": "Pack management",
  ...
  ja: {
    ...
    "settings.capability.graph:write": "エンティティ/関係",
    "settings.capability.query:write": "クエリ",
    "settings.capability.view:write": "ビュー定義",
    "settings.capability.schema:write": "スキーマ(型定義)",
    "settings.capability.asset:write": "アセット",
    "settings.capability.package:manage": "パック管理",
