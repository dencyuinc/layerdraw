...
export const schemaDigest = "sha256:ed3ac8277ff8d2d20a71530eda628e3e559c787869f772c913198a0d6bdb8196" as const;
...
export function isJsonValue(value: unknown): value is JsonValue {
  return (value === null) || (typeof value === "boolean") || (typeof value === "string" && hasScalarUnicode(value)) || (isJSONArray(value) && value.every((item) => isJsonValue(item))) || (isObject(value) && Object.values(value).every((item) => isJsonValue(item)));
}
