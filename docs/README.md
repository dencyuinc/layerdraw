...
- [architecture.md](architecture.md): LayerDraw Engine、TS presentation、framework shell、提供物を分離する規範Technical Architecture
...
- [engine-wasm-worker-transport-contract.md](engine-wasm-worker-transport-contract.md): browser専用Worker、Go `js/wasm` bridge、transfer所有権、lifecycle、固定上限、再現可能artifactの規範契約
